...
def run():   
    ...
    if ok == 'no': # There is a problem with the parameters and the images will be completly black
        ...
        if B0_field == 'B0_46mT':       
            script_dir = sys.path[0] # Will get the current directory
            T1_3D_grad = np.load(os.path.join(script_dir, 'Data\T1_3D_cer_lip_grad.npy'))
            T2_3D_grad = np.load(os.path.join(script_dir, 'Data\T2_3D_cer_lip_grad.npy'))
            M0_3D_grad = np.load(os.path.join(script_dir, 'Data\M0_3D_cer_lip_grad.npy'))
            B1map_3D_grad = np.load(os.path.join(script_dir, 'Data\B1_3D_cer_lip_grad.npy'))
            flipAngleMaprescale_3D_grad = np.load(os.path.join(script_dir, 'Data\FlipAngleMaprescale_3D_cer_lip_grad.npy'))
            t2_star_3D_grad = np.load(os.path.join(script_dir, 'Data\T2_star_tensor_3D_cer_lip_grad.npy'))
            ADC_3D_grad = np.load(os.path.join(script_dir, 'Data\ADC_3D_cer_lip_grad.npy'))    
            B0_3D = B0_3D_ori
        elif B0_field == 'B0_15T':
            script_dir = sys.path[0] # Will get the current directory
            T1_3D_grad = np.load(os.path.join(script_dir, 'Data\T1_15.npy'))
            T2_3D_grad = np.load(os.path.join(script_dir, 'Data\T2_15.npy'))
            M0_3D_grad = np.load(os.path.join(script_dir, 'Data\M0_3D_cerb_lip.npy'))
            B1map_3D_grad = np.load(os.path.join(script_dir, 'Data\B1_3D.npy'))
            flipAngleMaprescale_3D_grad = np.load(os.path.join(script_dir, 'Data\FlipAngleMaprescale_3D.npy'))
            t2_star_3D_grad = np.load(os.path.join(script_dir, 'Data\T2_star_15.npy'))
            ADC_3D_grad = np.load(os.path.join(script_dir, 'Data\ADC_3D.npy'))
            B0_3D = b_field * 32.608 # 1.5T / 46mT ~= 32.608
            B0_3D[B0_3D>0] = 1.5
        elif B0_field == 'B0_3T':
            script_dir = sys.path[0] # Will get the current directory
            T1_3D_grad = np.load(os.path.join(script_dir, 'Data\T1_3.npy'))
            T2_3D_grad = np.load(os.path.join(script_dir, 'Data\T2_3.npy'))
            M0_3D_grad = np.load(os.path.join(script_dir, 'Data\M0_3D_cerb_lip.npy'))
            B1map_3D_grad = np.load(os.path.join(script_dir, 'Data\B1_3D.npy'))
            flipAngleMaprescale_3D_grad = np.load(os.path.join(script_dir, 'Data\FlipAngleMaprescale_3D.npy'))
            t2_star_3D_grad = np.load(os.path.join(script_dir, 'Data\T2_star_3.npy'))
            ADC_3D_grad = np.load(os.path.join(script_dir, 'Data\ADC_3D.npy'))
...
def settings():
    ...
    script_dir = sys.path[0] # Will get the current directory
    T1_3D_46 = np.load(os.path.join(script_dir, 'Data\T1_3D_cer_lip_grad.npy'))
    T2_3D_46 = np.load(os.path.join(script_dir, 'Data\T2_3D_cer_lip_grad.npy'))
    T1_3D_15 = np.load(os.path.join(script_dir, 'Data\T1_15.npy'))
    T2_3D_15 = np.load(os.path.join(script_dir, 'Data\T2_15.npy')) 
    T1_3D_3 = np.load(os.path.join(script_dir, 'Data\T1_3.npy'))
    T2_3D_3 = np.load(os.path.join(script_dir, 'Data\T2_3.npy'))
...
def open_simu():
    ...
    if (B0_check == True) and (T2_check == False):
        ...
        T2 = np.load(os.path.join(script_dir, 'Data\T2_3D_cer_lip_grad.npy')) # unit of T2 map is in [s]
...
def create_3D_low_and_high_SNR_data(FOV, Resolution, Bandwidth, seq, TR, TE, TI, TI2, alpha, noise_factor\
    ...
    if B0_gene == '46':
        B0_const = 'B0_46mT'
        T1_3D = np.load(os.path.join(script_dir, 'Data\T1_3D_cer_lip_grad.npy'))
        T2_3D = np.load(os.path.join(script_dir, 'Data\T2_3D_cer_lip_grad.npy'))
        M0_3D = np.load(os.path.join(script_dir, 'Data\M0_3D_cer_lip_grad.npy'))
        B1map_3D = np.load(os.path.join(script_dir, 'Data\B1_3D_cer_lip_grad.npy'))
        flipAngleMaprescale_3D = np.load(os.path.join(script_dir, 'Data\FlipAngleMaprescale_3D_cer_lip_grad.npy'))
        t2_star_3D = np.load(os.path.join(script_dir, 'Data\T2_star_tensor_3D_cer_lip_grad.npy'))
        ADC_3D = np.load(os.path.join(script_dir, 'Data\ADC_3D_cer_lip_grad.npy'))
    elif B0_gene == '15':
        B0_const = 'B0_15T'
        script_dir = sys.path[0] # Will get the current directory
        T1_3D = np.load(os.path.join(script_dir, 'Data\T1_15.npy'))
        T2_3D = np.load(os.path.join(script_dir, 'Data\T2_15.npy'))
        M0_3D = np.load(os.path.join(script_dir, 'Data\M0_3D_cerb_lip.npy'))
        B1map_3D = np.load(os.path.join(script_dir, 'Data\B1_3D.npy'))
        flipAngleMaprescale_3D = np.load(os.path.join(script_dir, 'Data\FlipAngleMaprescale_3D.npy'))
        t2_star_3D = np.load(os.path.join(script_dir, 'Data\T2_star_15.npy'))
        ADC_3D = np.load(os.path.join(script_dir, 'Data\ADC_3D.npy'))
        #B0_3D = b_field * 32.608 # 1.5T / 46mT ~= 32.608
        #B0_3D[B0_3D>0] = 1.5
    elif B0_gene == '3':
        B0_const = 'B0_3T'
        script_dir = sys.path[0] # Will get the current directory
        T1_3D = np.load(os.path.join(script_dir, 'Data\T1_3.npy'))
        T2_3D = np.load(os.path.join(script_dir, 'Data\T2_3.npy'))
        M0_3D = np.load(os.path.join(script_dir, 'Data\M0_3D_cerb_lip.npy'))
        B1map_3D = np.load(os.path.join(script_dir, 'Data\B1_3D.npy'))
        flipAngleMaprescale_3D = np.load(os.path.join(script_dir, 'Data\FlipAngleMaprescale_3D.npy'))
        t2_star_3D = np.load(os.path.join(script_dir, 'Data\T2_star_3.npy'))
        ADC_3D = np.load(os.path.join(script_dir, 'Data\ADC_3D.npy'))
        #B0_3D = b_field * 65.217  # 3T / 46mT ~= 65.217
        #B0_3D[B0_3D>0] = 3
...
def new_dataset_gene():
    ...
    # Read Images
    script_dir = sys.path[0] # Will get the current directory
    img1_gene = Image.open(os.path.join(script_dir, 'Images\Generator1.png'))
    img2_gene = Image.open(os.path.join(script_dir, 'Images\Generator2.png'))
    img3_gene = Image.open(os.path.join(script_dir, 'Images\Generator3.png'))
...
# B0
global B0_3D
B0_3D = np.nan_to_num(np.load(os.path.join(script_dir, 'Data\Tom-B0.npy')))
...
script_dir = sys.path[0] # Will get the current directory
img1 = Image.open(os.path.join(script_dir, 'Images\Slide1.jpg'))
img2 = Image.open(os.path.join(script_dir, 'Images\Slide2.jpg'))
